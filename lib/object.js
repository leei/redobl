...
var RedObject = exports.RedObject = function (setup) {
  this.attrs = _.clone(this.constructor.defaults);
  // Now extend with the rest of the values passed in as setup.
  _.extend(this.attrs, setup);
}
